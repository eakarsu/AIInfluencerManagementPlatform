...
// Auto-generated page for: No fake-follower / fraud detector

export default function GapNoFakeFollowerFraudDetector() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-fake-follower-fraud-detector', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No fake-follower / fraud detector</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No fake-follower / fraud detector</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No fake-follower / fraud detector'}
        </button>
      </form>
