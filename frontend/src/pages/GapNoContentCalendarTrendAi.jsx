...
// Auto-generated page for: No content-calendar trend AI

export default function GapNoContentCalendarTrendAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-content-calendar-trend-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No content-calendar trend AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No content-calendar trend AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No content-calendar trend AI'}
        </button>
      </form>
