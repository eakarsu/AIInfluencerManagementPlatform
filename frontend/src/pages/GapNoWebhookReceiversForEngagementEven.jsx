...
// Auto-generated page for: No webhook receivers for engagement events

export default function GapNoWebhookReceiversForEngagementEven() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-webhook-receivers-for-engagement-even', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No webhook receivers for engagement events</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No webhook receivers for engagement events</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No webhook receivers for engagement events'}
        </button>
      </form>
