...
// Auto-generated page for: No performance-prediction model

export default function GapNoPerformancePredictionModel() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-performance-prediction-model', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No performance-prediction model</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No performance-prediction model</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No performance-prediction model'}
        </button>
      </form>
