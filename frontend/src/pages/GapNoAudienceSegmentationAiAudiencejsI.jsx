...
// Auto-generated page for: No audience-segmentation AI (audience

export default function GapNoAudienceSegmentationAiAudiencejsI() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-audience-segmentation-ai-audiencejs-i', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No audience-segmentation AI (audience</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No audience-segmentation AI (audience.js is rule-based)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No audience-segmentation AI (audience'}
        </button>
      </form>
