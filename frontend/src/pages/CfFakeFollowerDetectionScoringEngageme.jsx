...
// Auto-generated page for: Fake-follower detection scoring engagement authenticity

export default function CfFakeFollowerDetectionScoringEngageme() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-fake-follower-detection-scoring-engageme', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Fake-follower detection scoring engagement authenticity</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Fake-follower detection scoring engagement authenticity.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Fake-follower detection scoring engagement authenticity'}
        </button>
      </form>
