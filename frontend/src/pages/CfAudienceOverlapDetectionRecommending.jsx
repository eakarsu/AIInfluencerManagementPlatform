...
// Auto-generated page for: Audience overlap detection recommending complementary influe

export default function CfAudienceOverlapDetectionRecommending() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-audience-overlap-detection-recommending-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Audience overlap detection recommending complementary influe</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Audience overlap detection recommending complementary influencer combinations.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Audience overlap detection recommending complementary influe'}
        </button>
      </form>
