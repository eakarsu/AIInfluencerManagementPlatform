...
export BACKEND_URL="${BACKEND_URL:-http://127.0.0.1:${BACKEND_PORT:-3001}}"
(cd "$project_dir/frontend" && npm run dev -- --host "${FRONTEND_HOST:-127.0.0.1}" --port "${FRONTEND_PORT:-3000}") & frontend_pid=$!
